...
class EditMembersScreen extends StatefulWidget {
  const EditMembersScreen({super.key, this.member});
...
class _EditMembersScreenState extends State<EditMembersScreen> {
  ...
  bool get _isMemberEdit => widget.member != null;
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      if (widget.member != null) {
        ...
        final loadedUser = userProvider.user;
        if (loadedUser == null) {
  ...
  Future<void> _saveChanges() async {
    final emailRequired = !_isMemberEdit;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_isMemberEdit ? 'Editar Membro' : 'Editar Usuário'),
        centerTitle: true,
      ),
      body: _isLoading
